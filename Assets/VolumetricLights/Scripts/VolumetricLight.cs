...
namespace VolumetricLights {
    ...
    public partial class VolumetricLight : MonoBehaviour {
        ...
        // Common
        public LightMode lightMode = LightMode.Volumetric;
        ...
        Shader fogMatShader, fogMatSimpleShader, fogMatInvisibleShader;
        ...
        void UpdateMaterialPropertiesNow() {
            ...
            Shader targetShader = lightMode == LightMode.Simple ? fogMatSimpleShader : fogMatShader;
