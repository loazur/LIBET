...
namespace VolumetricLights {
    ...
    public partial class VolumetricLightEditor : Editor {
        ...
        void OnEnable () {
            ...
            canUseTranslucency =  vl.CheckCompatiblePipelineArchitecture();
        }
        ...
        public override void OnInspectorGUI() {
            ...
            if (lightMode.intValue == (int)VolumetricLight.LightMode.Volumetric && useNoise.boolValue) {
            ...
            if (lightMode.intValue == (int)VolumetricLight.LightMode.Volumetric) {
                ...
                if (shadowTranslucency.boolValue) {
                    if (!canUseTranslucency) {
                        EditorGUILayout.HelpBox("Translucent shadow maps are not supported in DX12 with Foreward+/Deferred+. Switch to DX11 or change rendering path.", MessageType.Warning);
                    } else 
