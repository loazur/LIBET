...
v10.4.2
- [Fix] DX12 + Forward+/Deferred+ fixes. Translucency feature not supported in this specific setup. It will fallback to regular shadow casting with no translucency.
